...
overwatch = logging.get_logger(__name__)  
    ...
    "llava-laion-cc-sbu-558k": [
        {
            ...
            "extract": False,
            "url": "https://hf-mirror.com/datasets/liuhaotian/LLaVA-Pretrain/resolve/main/blip_laion_cc_sbu_558k.json",
            "do_rename": True,
        },
        {
            ...
            "url": "https://hf-mirror.com/datasets/liuhaotian/LLaVA-Pretrain/resolve/main/images.zip",
            "do_rename": False,
        }
    ],
...
if __name__ == "__main__":
    root_dir  = "/share/henry/mllm_data/robomamba"
