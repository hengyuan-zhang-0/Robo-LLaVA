...
MID_RUN_NAME=llavaov-fromScratch-1*1-visualfrozen-$NNODES-$CURRENT_TIME
...
#ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node="${NUM_GPUS}" --nnodes="${NNODES}" --node_rank="${RANK}" --master_addr="${ADDR}" --master_port="${PORT}" \
    ...
    --image_folder /home/lmz/data/llava-v1.5-instruct \
    --video_folder /home/world_model/robovqa/videos \
