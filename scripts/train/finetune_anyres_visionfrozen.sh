...
MID_RUN_NAME='llavapv-fromScratch-anyres-visualfrozen'
# LLM_PATH='/share/henry/mllm_checkpoints/Qwen2-7B-Instruct'
#ACCELERATE_CPU_AFFINITY=1 torchrun --nproc_per_node="${NUM_GPUS}" --nnodes="${NNODES}" --node_rank="${RANK}" --master_addr="${ADDR}" --master_port="${PORT}" \
    #CUDA_VISIBLE_DEVICES=0 
    deepspeed llava/train/train_mem.py \
    --deepspeed scripts/zero2.json \
    --model_name_or_path '/share/huggingface/hub/models--Qwen--Qwen2-7B-Instruct/snapshots/f2826a00ceef68f0f2b946d945ecc0477ce4450c' \
    ...
    --vision_tower '/share/huggingface/hub/models--google--siglip-so400m-patch14-384/snapshots/7067f6db2baa594bab7c6d965fe488c7ac62f1c8' \
