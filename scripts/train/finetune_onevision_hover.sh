...
VISION_MODEL_VERSION="/mnt/hpfs/baaiei/hub/models--google--siglip-so400m-patch14-384"
...
BASE_MODEL_PATH='/mnt/hpfs/baaiei/model_zoo/llava-onevision-qwen2-7b-ov'
...
ADDR=10.9.200.87
PORT=9205
MID_RUN_NAME='llava-onevision-qwen2-7b-ov-robovqa_only'
